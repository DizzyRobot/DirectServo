...
void setPwmTorque() {
	...
	{
		if (ReportedAngle >= config->Failsafe.MaxAngle && usartTorqueCommandValue > config->Failsafe.TorqueLimit)
			usartTorqueCommandValue = config->Failsafe.TorqueLimit;
		else if (ReportedAngle <= config->Failsafe.MinAngle && usartTorqueCommandValue < -config->Failsafe.TorqueLimit)
			usartTorqueCommandValue =  -config->Failsafe.TorqueLimit;
	}
