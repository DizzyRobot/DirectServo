...
const int32_t DefaultMaxAngle = 0x7FFF0000; // 0x7FFF0000 is the max value ReportedAngle. Which is the max of TrackedAngle (a int32_t) minus the max value of StartupAngle (a uint16_t)
struct FailsafeConfig
{
    ...
    int32_t MaxAngle = DefaultMaxAngle;
    int32_t MinAngle = -DefaultMaxAngle;
};
...
bool LimitCalibrate(bool UseFlash, int32_t NewTorqueLimit = TorqueLimitMax,
...
extern uint32_t gTickCount_last;
extern int32_t gVel_last;
extern uint8_t MaxAccel;
